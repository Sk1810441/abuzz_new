...
const routes: Routes = [
  ...
  { path: 'profile', component: ProfilerouterComponent ,canActivate: [AuthGuard] , data: { breadcrumb: 'Profile'},
    children : [ 
      ...
      {path: 'bookinghistory', component: BookinghistoryrouterComponent ,canActivate: [AuthGuard] , data: { breadcrumb: 'Booking History'},
        children : [
          { path: '', component: BookinghistoryComponent ,canActivate: [AuthGuard] , data: { breadcrumb: 'Booking History'} },
          { path: 'bookingdetail/:masterBookingId', component: BookingdetailComponent ,canActivate: [AuthGuard] , data: { breadcrumb: 'Booking Detail'}  },
        ],
      },
    ],
  },
